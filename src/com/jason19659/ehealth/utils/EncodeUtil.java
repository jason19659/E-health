...
public class EncodeUtil {  
  ...
  static {  
      try {  
          ...
          System.err.println(EncodeUtil.class.getName()  
  ...
  public static String encodePassword(String s) {
	  String p = getMD5String(getMD5String(s) + "jason19659");
	  return getMD5String(p.substring(0, 10) +  p + "jason19659@163.com");
  }
   ...
   * @return 
   */  
  public static boolean checkPassword(String input, String inDB) {  
      String s = encodePassword(input);  
      return s.equals(inDB);  
  }  
